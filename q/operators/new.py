 ...
 def register_command(name: str, handler: CommandHandler, description: str) -> None:                                                                            
     ...
     """                                                                                                                                                        
     command_registry = (handler, description)                                                                                                                  
 ...
 def handle_command(input_text: str, context: Optional[Dict] = None) -> bool:                                                                                   
     """                                                                                                                                                        
 ...
 def list_commands() -> None:                                                                                                                                   
     ...
     for cmd, (_, description) in sorted(command_registry.items()):                                                                                             
         q_console.print(f"  {cmd}: {description}")                                                                                                             
                                                                                                                                                                
     q_console.print("")                                                                                                                                        
                                                                                                                                                                
                                                                                                                                                                
 def get_all_commands() -> List[Tuple]:                                                                                                                         
     """                                                                                                                                                        
 ...
 def get_slash_commands() -> List[Tuple]:                                                                                                                       
     """                                                                                                                                                        
 ...
 class CommandCompleter(Completer):                                                                                                                             
     ...
     def get_completions(                                                                                                                                       
         ...
         if word_count > 1 or (word_count == 1 and on_space):                                                                                                   
             ...
             # --- Argument completion for /save, /save-session, /load-session ---\n                                                                            
             ...
             if command in ["/save", "/save-session", "/load-session"]:                                                                                         
                 return                                                                                                                                         
 ...
 def handle_t_budget_command(args: str, context: Dict) -> bool:                                                                                                 
     """                                                                                                                                                        
 ...
 def handle_exit_command(args: str, context: Dict) -> bool:                                                                                                     
     """                                                                                                                                                        
 ...
 def handle_save_command(args: str, context: Dict) -> bool:                                                                                                     
     """                                                                                                                                                        
     ...
     """                                                                                                                                                        
     if not args:                                                                                                                                               
         show_error("No file path provided. Usage: /save ")                                                                                                     
 ...
 def handle_help_command(args: str, context: Dict) -> bool:                                                                                                     
     """                                                                                                                                                        
 ...
 def handle_clear_command(args: str, context: Dict) -> bool:                                                                                                    
     """                                                                                                                                                        
     ...
     q_console.print(                                                                                                                                           
         f"Q ver:{__version__} - brain:{get_current_model(conversation)}"                                                                                       
     )                                                                                                                                                          
 ...
 def handle_recover_command(args: str, context: Dict) -> bool:                                                                                                  
     """                                                                                                                                                        
 ...
 def handle_transplant_command(args: str, context: Dict) -> bool:                                                                                               
     """                                                                                                                                                        
     ...
     if not args:                                                                                                                                               
         ...
         if conversation:                                                                                                                                       
             ...
             q_console.print(                                                                                                                                   
                 f"Currently using: {current_provider}/{current_model_str}"                                                                                     
             )                                                                                                                                                  
         else:                                                                                                                                                  
             q_console.print(                                                                                                                                   
                 "Could not determine the currently active model."                                                                                              
             )                                                                                                                                                  
                                                                                                                                                                
         # Show available models                                                                                                                                
         q_console.print("Available brains:")                                                                                                                   
         for model_info in constants.MODELS:                                                                                                                    
             q_console.print(                                                                                                                                   
                 f"  {model_info['provider']}/{model_info['model']}: {model_info['description']}"                                                               
             )                                                                                                                                                  
         return True  # Command was handled (though with an error)\n                                                                                            
     ...
     if not found_model:                                                                                                                                        
         ...
         q_console.print("Available models:")                                                                                                                   
         for model_info in constants.MODELS:                                                                                                                    
             q_console.print(                                                                                                                                   
                 f"  {model_info['provider']}/{model_info['model']}: {model_info['description']}"                                                               
             )                                                                                                                                                  
 ...
 def handle_save_session_command(args: str, context: Dict) -> bool:                                                                                             
     """                                                                                                                                                        
 ...
 def handle_load_session_command(args: str, context: Dict) -> bool:                                                                                             
     """                                                                                                                                                        
     ...
     if not status_func:                                                                                                                                        
          ...
          logger.error("handle_load_session_command called without status_func in context")                                                                     
          return True                                                                                                                                           
                                                                                                                                                                
     if not args:                                                                                                                                               
         show_error("No file path provided. Usage: /load-session <file_path>")                                                                                  
         return True                                                                                                                                            
                                                                                                                                                                
     # Expand user path (~/)                                                                                                                                    
     file_path = os.path.expanduser(args.strip())                                                                                                               
                                                                                                                                                                
     success, message, loaded_messages = load_conversation_pickle(conversation, file_path)                                                                      
     ...
     if success:                                                                                                                                                
         ...
         if loaded_messages is not None and len(loaded_messages) > 0:                                                                                           
             ...
             with status_func("Generating summary..."):                                                                                                         
                  summary = get_session_summary(conversation) # Use the conversation object with loaded messages                                                
 ...
 register_command("/save-session", handle_save_session_command, "Save the current conversation session to a pickle file") # Register new command                
 register_command("/load-session", handle_load_session_command, "Load a conversation session from a pickle file") # Register new command                        
 ...
 register_command(                                                                                                                                              
     ...
     "Recover a previous session (last N turns) from the auto-save file", # Updated description                                                                 
 )                                                                                                                                                              
 register_command(                                                                                                                                              
     "/transplant",                                                                                                                                             
